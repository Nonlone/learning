...
# jdk
JDK8_LIB_HOME="/Library/Java/JavaVirtualMachines/openjdk-8.jdk/Contents/Home/lib"
# export JAVA_HOME="$HOME/.jenv/versions/"`jenv version-name`
export CLASSPATH=".;$JDK8_LIB_HOME/dt.jar;$JDK8_LIB_HOME/tools.jar;";
export MAVEN_OPTS="-classpath $CLASSPATH"
